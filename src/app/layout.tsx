...
<a href='/plant' className='transform motion-safe:hover:scale-110'>Les plantes</a>
<a href='/Give' className='transform motion-safe:hover:scale-110'>Donner</a>
<a href='/Find' className='transform motion-safe:hover:scale-110'>Rechercher</a>
<a href='/Around' className='transform motion-safe:hover:scale-110'>Autour de moi</a>
<a href='/Profil' className='transform motion-safe:hover:scale-110'>Profil</a>
